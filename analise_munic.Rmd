...
file5 <- "https://raw.githubusercontent.com/thais01fernandes/C-Users-Thais.Pereira-Documents-pessoal-mestrado-An-lise-Mestrado/main/PlanosdeMobilidadeUrbana.csv"
plano_mob <- read_delim(file5, delim = ",")

file6 <- "https://raw.githubusercontent.com/thais01fernandes/C-Users-Thais.Pereira-Documents-pessoal-mestrado-An-lise-Mestrado/main/ginibr.csv"
munic_gini <- read_delim(file6, delim = ";", 
                         locale = locale(encoding='latin1'))
...
# os arquivos foram colocados todos em uma pasta do computador 
...
```
  **8. PIB per capta dos municípios** 
...
```
  ...
  **9. Índice de Desenvolvimento Humano IDHM**
...
banco_completo_6  %>% 
  ...
  theme_minimal()+
  labs(fill = "Tem Política de FFTP?", 
       title = "Índice de Desenvolvimento Humano Municipal (IDHM)")+
  theme(
    axis.title.x = element_blank(),
    panel.background = element_blank(),
    axis.title.y = element_blank())
