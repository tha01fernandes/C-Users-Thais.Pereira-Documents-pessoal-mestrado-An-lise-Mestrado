...
```
  ...
  Há uma diferença entre as médias da taxa de urbanização dos municípios que adotaram FFTP e os que não adotaram.A taxa média do primeiro grupo é `r media_urbanizacao_fftp`% enquanto do segundo é `r media_urbanizacao_geral`%. No o primeiro grupo, os municípios de interesse desta pesquisa,dois municípios aparecem com valores que se aproximam da média do segundo grupo, Itatiaiuçu (MG) com 62% de urbanização e Pitanga (PR) com 63%.Os outros municípios apresentam urbanização maior que 70%.O gráfico de boxplot ilustra bem as médias da taxa de urbanização enquanto o grafico de densidade, logo abaixo, ilustra a distribuição das taxas de urbanização em todos os municípios estudados.  
...
```
   ...
   Esses são os Municípios com a Política de Tarifa Zero que possuem plano de mobilidade urbana como estabelecido pela Lei Federal nº 12.587/2012, segundo levantamento da Secretaria Nacional de Mobilidade e Serviços Urbanos (SEMOB),foi atualizado pela última vez em fevereiro de 2019. 
...
```
  6. PIB per capta dos municípios 
...
O IDHM médio dos municípios estudados é de `r media_idh_1` enquanto a média nos municípios brasileiros que não adotaram a política é `r media_idh_2`, exatamente o mesmo.
...
A média do IDHM Renda dos municípios estudados é de `r media_idh_renda_1` enquanto a média nos municípios brasileiros que não adotaram a política é `r media_idh_renda_2`, exatamente o mesmo.
...
A média do IDHM Renda dos municípios estudados é de `r media_idh_longevidade_1` enquanto a média nos municípios brasileiros que não adotaram a política é `r media_idh_logenvidade_2`
